...
int main() {
	...
	if (length != numberOfRow * numberOfColumn) {
		screen[numberOfRow / 2][numberOfColumn - 1] = 'G'; screen[numberOfRow / 2][numberOfColumn] = 'A';
		screen[numberOfRow / 2][numberOfColumn + 1] = 'M'; screen[numberOfRow / 2][numberOfColumn + 2] = 'E';
		screen[numberOfRow / 2 + 1][numberOfColumn - 1] = 'O'; screen[numberOfRow / 2 + 1][numberOfColumn] = 'V';
		screen[numberOfRow / 2 + 1][numberOfColumn + 1] = 'E'; screen[numberOfRow / 2 + 1][numberOfColumn + 2] = 'R';
	}
	else {
...
void quaternaryVectorInterpreter(int quaternaryVector, int* currentRow, int* currentColumn) {
	...
	case 0: ++ * currentColumn; break;
	case 2: -- * currentColumn; break;
